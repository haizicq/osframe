...
<%@include file="/common/jsp/index_top.jsp"%>
   <!-- navbar -->
    ...
    <!-- menu -->
    <div data-ng-include=" '${rootPath}/core/users/nav.html' " class="app-aside hidden-xs {{app.settings.asideColor}}">
    </div>
    <!-- / menu -->
...
<script>
    // seajs config
    G.path.modulePath="./";
    G.path.moduleResPath="${rootPath}/resource/core/users";
    G.path.moduleTemplatePath="${rootPath}/core/users";//模块资源位置
