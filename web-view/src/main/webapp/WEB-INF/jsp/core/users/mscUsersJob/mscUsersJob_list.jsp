...
<div class="wrapper-md" ng-controller="mscUsersJobListCtrl">
    <div >
        <!-- breadcrumb -->
        <ul class="breadcrumb bg-white b-a">
            <li><i class="glyphicon glyphicon-list"></i> <fmt:message key="mscUsersJob.module"/></li>
        </ul>
        <!-- / breadcrumb -->
    </div>
        ...
        <div class="row wrapper">
            ...
            <div class="col-sm-7">
                <div class="pull-right">
                    <bs:role controller="MscUsersJobController" function="add" >
                        <button type="button" class="btn btn-default " ui-sref="mscUsersJobAdd"><fmt:message key="button.add"/></button>
                    </bs:role>
                    <bs:role controller="MscUsersJobController" function="deleteMul" >
                        <button type="button" class="btn btn-default " ng-select-delete="mscUsersJob(mscUsersJobIds)"><fmt:message key="button.delete"/></button>
                    </bs:role>
        ...
        <div class="table-responsive">
            <table class="table table-striped b-t b-light">
                ...
                <tr>
                    <th style="width:20px;">
                        <label class="i-checks m-b-none">
                            <input type="checkbox"  ng-all-checkbox="mscUsersJobIds"><i></i>
                        </label>
                    </th>
                ...
                <tbody>
                    ...
                    <c:forEach items="${pageInfoList.list}" var="mscUsersJob" varStatus="status">

                        
     <tr>
            <td><label class="i-checks m-b-none"><input type="checkbox" name="mscUsersJobIds" ng-checkbox value="${mscUsersJob.pkId}"><i></i></label></td>
         ...
         <td>${mscUsersOrg.lbUsersInfo.lbParent.lbName} </td>
            <td>
                <a ui-sref="mscUsersJobLook({id:'${mscUsersJob.pkId}'})"><span class="font-bold" ><fmt:message key="button.view"/></span>  </a>
            </td>
     </tr>
                    </c:forEach>
